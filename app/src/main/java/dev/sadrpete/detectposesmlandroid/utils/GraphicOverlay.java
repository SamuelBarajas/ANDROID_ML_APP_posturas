...
package dev.sadrpete.detectposesmlandroid.utils;
...
public class GraphicOverlay extends View {
   ...
   * instances to the overlay using {@link dev.sadrpete.detectposesmlandroid.utils.GraphicOverlay#add(Graphic)}.
   */
  public abstract static class Graphic {
    private dev.sadrpete.detectposesmlandroid.utils.GraphicOverlay overlay;

    public Graphic(dev.sadrpete.detectposesmlandroid.utils.GraphicOverlay overlay) {
